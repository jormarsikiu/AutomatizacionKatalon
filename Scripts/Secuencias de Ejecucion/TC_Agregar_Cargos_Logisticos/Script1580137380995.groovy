...
WebUI.callTestCase(findTestCase('Individual_Tests_20pies/Agregar_Logistica'), [('IDCliente') : IDCliente, ('CreadosDesde') : CreadosDesde, ('CreadosHasta') : CreadosHasta
        , ('IDPedido') : IDPedido], FailureHandling.STOP_ON_FAILURE)
