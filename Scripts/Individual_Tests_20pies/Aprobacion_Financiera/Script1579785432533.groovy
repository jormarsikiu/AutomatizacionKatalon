...
List<String> data = CustomKeywords.'obtener_excels.obtener_aprobaciones_20pies.getValuesExcelAprob20'(Index)
String IdPedido = data[3]
String Id_Cliente = data[4]
String AprobFinanciera = data[6]

IDPedido = IdPedido
IDCliente = Id_Cliente
AprobacionFinanciera = AprobFinanciera
