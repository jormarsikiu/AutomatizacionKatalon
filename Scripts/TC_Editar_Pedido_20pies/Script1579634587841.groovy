...
WebUI.callTestCase(findTestCase('Individual_Tests/Seleccionar_Productos'), [('Presentacion') : Presentacion, ('Producto') : Producto, ('Cantidad') : Cantidad, ('Presentacion2') : Presentacion2
