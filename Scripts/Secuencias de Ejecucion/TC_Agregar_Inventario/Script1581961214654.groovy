...

{
	...
	WebUI.callTestCase(findTestCase('Individual_Tests_20pies/Inventario'), [('Index') : Index, ('CodigoProducto') : CodigoProducto, ('Cantidad') : Cantidad], FailureHandling.STOP_ON_FAILURE)
