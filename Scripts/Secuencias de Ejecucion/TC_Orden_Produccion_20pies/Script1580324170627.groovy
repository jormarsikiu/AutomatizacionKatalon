...
WebUI.callTestCase(findTestCase('Individual_Tests_20pies/Orden_Produccion'), [('IDCliente') : IDCliente, ('IDPedido') : IDPedido, ('CreadosDesde') : CreadosDesde, ('CreadosHasta') : CreadosHasta], FailureHandling.STOP_ON_FAILURE)
