...
for (def Index = 1; Index <= excelData.getRowNumbers(); Index++) {
    WebUI.callTestCase(findTestCase('Individual_Tests/Login'), [('Evento') : 'Despacho', ('Index') : Index, ('Usuario') : Usuario
            , ('Contrasena') : Contrasena], FailureHandling.STOP_ON_FAILURE)

    WebUI.callTestCase(findTestCase('Individual_Tests/Seleccionar_Idioma'), [('Evento') : 'Despacho', ('Index') : Index], 
        FailureHandling.STOP_ON_FAILURE)

    WebUI.callTestCase(findTestCase('Individual_Tests/Despacho'), [('Index') : Index], 
        FailureHandling.STOP_ON_FAILURE)
}
