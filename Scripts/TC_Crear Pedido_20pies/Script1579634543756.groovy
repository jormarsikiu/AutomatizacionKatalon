...
WebUI.callTestCase(findTestCase('Individual_Tests/Seleccionar_Cliente'), [('Nombre') : Nombre, ('Direccion') : Direccion
...
WebUI.callTestCase(findTestCase('Individual_Tests/Seleccionar_Productos'), [('Iterar') : Iterar, ('Presentacion') : Presentacion
